...
RSpec.describe LinksController, type: :controller do
  ...
  let(:valid_attributes) {
    {name: "A Valid Name", url: "www.avalidurl.com", subtitle: "A Valid Subtitle"}
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        {name: "A New Valid Name", url: "www.validurlchanged.com", subtitle: "A Valid Subtitle"}
      }
      ...
      it "updates the requested link" do
        ...
        link.reload
        expect(link[:name]).to eq "A New Valid Name"
        expect(link[:url]).to eq "www.validurlchanged.com"
        expect(link[:subtitle]).to eq "A Valid Subtitle"
      end
